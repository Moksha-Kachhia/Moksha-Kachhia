# 💫 About Me:
🙌 Hi there I’m Moksha Kachhia! :)<br><br>🎓 I’m a third-year Computer Science and Statistics student at the University of Toronto, passionate about exploring emerging technologies!<br><br>🎯 Currently seeking a Summer ’26 Software Engineering/Machine Learning Engineer co-op internship.<br><br>🖥️ The languages I am familiar with are: Java, Python, C, C++, CSS, JavaScript, and LaTeX. I am comfortable using Git, VSCode, GitHub, MongoDB, React.js, Node.js, Firebase, AWS, PostgreSQL, Figma, and the Microsoft Suite.<br><br>💼  have experience in web development, machine learning, and AI Chatbot testing, through my roles as a MLE Engineer Intern, Technical Systems Analyst intern, and Software Developer.<br><br>🏆 I received 1st place in the Summer 2025 RBC T&O Case Competition, the ‘Best Sustainability Project’ win for the 2023 Da Vinci Entrepreneurship Hackathon, a Renewable Entrance Scholarship from the University of Toronto, and the Computer Science Award upon graduation from Donald A Wilson Secondary School.<br><br>📚 Completed courses in linear algebra, calculus, discrete mathematics, and probability, focusing on combinatorics, proof theory, and statistical analysis. I have studied the theory of computation and software design, learning SDLC and proving the correctness of programs. I also gained practical experience using Python, C, and Java through my coursework.
